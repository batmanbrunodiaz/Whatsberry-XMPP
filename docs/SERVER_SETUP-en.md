...
**For complete HTTP server documentation**, see [HTTP_SERVER-en.md](HTTP_SERVER-en.md) which covers:
...
- **[🌐 HTTP Server Setup (HTTP_SERVER-en.md)](HTTP_SERVER-en.md)** - Complete Nginx configuration guide
- **[🐛 Troubleshooting (TROUBLESHOOTING-en.md)](TROUBLESHOOTING-en.md)** - Detailed proxy troubleshooting
- **[📱 Client Configuration (CLIENT_CONFIGURATION-en.md)](CLIENT_CONFIGURATION-en.md)** - Client configuration guide
- **[🏗️ Architecture Diagrams (ARCHITECTURE_DIAGRAMS-en.md)](ARCHITECTURE_DIAGRAMS-en.md)** - Visual system architecture
- **[📝 Changelog (CHANGELOG-en.md)](CHANGELOG-en.md)** - Version history
...
- Check [TROUBLESHOOTING-en.md](TROUBLESHOOTING-en.md) for detailed troubleshooting
- Check [HTTP_SERVER-en.md](HTTP_SERVER-en.md) for HTTP/Nginx issues
- Review logs: `sudo journalctl -u xmpp-tls-proxy -f`
- Consult [Complete Documentation Index](README-en.md)
